...
const ClassSubmissions = () => {
      ...
      () => {
        ...
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
          ...
          getDoc(docRef).then((docSnap) => {
            ...
            let tempSubmissions = classRoomData.submissions;
  ...
  const fetchSubmission = async () => {
    ...
    const classRoomData = docSnap.data();
    const fetchedSubmissions = classRoomData.submissions;
    fetchedSubmissions.sort(function (a, b) {
          ...
          <Container sx={{ my: 2 }}>
            ...
            >
              <Container>
                ...
                <p style={{ fontSize: 12 }}>{submission.name}</p>
                <p style={{ fontSize: 10 }}>{submission.createdAt}</p>
              </Container>
            </Alert>
          </Container>
        ))}
...
export default ClassSubmissions;
